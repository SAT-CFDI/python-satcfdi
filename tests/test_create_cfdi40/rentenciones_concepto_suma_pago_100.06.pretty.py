{'Addenda': None,
 ...
 'Complemento': {'Pago': [{'DoctoRelacionado': [{'EquivalenciaDR': 1,
                           ...
                           'ImpuestosP': {'RetencionesP': [{'ImporteP': Decimal('60.04'),
                                          ...
                                          'TrasladosP': [{'BaseP': Decimal('600.36'),
                                                          'ImporteP': Decimal('96.06'),
                                                          'ImpuestoP': <Impuesto.IVA: '002'>,
                                                          'TasaOCuotaP': Decimal('0.160000'),
                                                          'TipoFactorP': <TipoFactor.TASA: 'Tasa'>}]},
                           'MonedaP': 'MXN',
                           'Monto': Decimal('572.34'),
                           'TipoCambioP': 1}],
                 'Totales': {'MontoTotalPagos': Decimal('572.34'),
                             'TotalRetencionesISR': Decimal('60.04'),
                             'TotalRetencionesIVA': Decimal('64.04'),
                             'TotalTrasladosBaseIVA16': Decimal('600.36'),
                             'TotalTrasladosImpuestoIVA16': Decimal('96.06')},
                 'Version': '2.0'},
 ...
 'Receptor': {'DomicilioFiscalReceptor': '59820',
              ...
              'Rfc': 'KIJ0906199R1',
              'UsoCFDI': 'CP01'},
 'Sello': '',
 'Serie': 'A',
 'SubTotal': Decimal('0'),
 'TipoCambio': None,
 'TipoDeComprobante': 'P',
