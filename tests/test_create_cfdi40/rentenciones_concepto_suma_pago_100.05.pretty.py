{'Addenda': None,
 ...
 'Complemento': {'Pago': [{'DoctoRelacionado': [{'EquivalenciaDR': 1,
                                                 ...
                                                 'ImpPagado': Decimal('572.29'),
                                                 'ImpSaldoAnt': Decimal('572.29'),
                                                 'ImpSaldoInsoluto': Decimal('0.00'),
                                                 'ImpuestosDR': {'RetencionesDR': [{'BaseDR': Decimal('600.30'),
                                                                                    'ImporteDR': Decimal('60.03'),
                                                                                    'ImpuestoDR': <Impuesto.ISR: '001'>,
                                                                                    'TasaOCuotaDR': Decimal('0.100000'),
                                                                                    'TipoFactorDR': <TipoFactor.TASA: 'Tasa'>},
                                                                                   {'BaseDR': Decimal('600.30'),
                                                                                    'ImporteDR': Decimal('64.03'),
                                                                                    'ImpuestoDR': <Impuesto.IVA: '002'>,
                                                                                    'TasaOCuotaDR': Decimal('0.106667'),
                                                                                    'TipoFactorDR': <TipoFactor.TASA: 'Tasa'>}],
                                                                 'TrasladosDR': [{'BaseDR': Decimal('600.30'),
                                                                                  'ImporteDR': Decimal('96.05'),
                                                                                  'ImpuestoDR': <Impuesto.IVA: '002'>,
                           ...
                           'FormaDePagoP': '03',
                           'ImpuestosP': {'RetencionesP': [{'ImporteP': Decimal('60.03'),
                                                            'ImpuestoP': <Impuesto.ISR: '001'>},
                                                           {'ImporteP': Decimal('64.03'),
                                                            'ImpuestoP': <Impuesto.IVA: '002'>}],
                                          'TrasladosP': [{'BaseP': Decimal('600.30'),
                                                          'ImporteP': Decimal('96.05'),
                                                          'ImpuestoP': <Impuesto.IVA: '002'>,
                                                          'TasaOCuotaP': Decimal('0.160000'),
                                                          'TipoFactorP': <TipoFactor.TASA: 'Tasa'>}]},
                           'MonedaP': 'MXN',
                           'Monto': Decimal('572.29'),
                           'TipoCambioP': 1}],
                 'Totales': {'MontoTotalPagos': Decimal('572.29'),
                             'TotalRetencionesISR': Decimal('60.03'),
                             'TotalRetencionesIVA': Decimal('64.03'),
                             'TotalTrasladosBaseIVA16': Decimal('600.30'),
                             'TotalTrasladosImpuestoIVA16': Decimal('96.05')},
                 'Version': '2.0'},
 ...
 'Receptor': {'DomicilioFiscalReceptor': '59820',
              ...
              'Rfc': 'KIJ0906199R1',
              'UsoCFDI': 'CP01'},
 'Sello': '',
 'Serie': 'A',
 'SubTotal': Decimal('0'),
 'TipoCambio': None,
 'TipoDeComprobante': 'P',
