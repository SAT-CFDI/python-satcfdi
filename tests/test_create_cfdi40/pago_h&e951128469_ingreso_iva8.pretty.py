{'Addenda': None,
 ...
 'Complemento': {'Pago': [{'DoctoRelacionado': [{'EquivalenciaDR': 1,
                           ...
                           'ImpuestosP': {'TrasladosP': [{'BaseP': Decimal('15390.30'),
                                                          'ImporteP': Decimal('1231.22'),
                                                          'ImpuestoP': Code('002', 'IVA'),
                                                          'TasaOCuotaP': Decimal('0.080000'),
                                                          'TipoFactorP': Code('Tasa', None)}]},
                           'MonedaP': Code('MXN', 'Peso Mexicano'),
                           'Monto': Decimal('16621.52'),
                           'TipoCambioP': 1}],
                 'Totales': {'MontoTotalPagos': Decimal('16621.52'),
                             'TotalTrasladosBaseIVA8': Decimal('15390.30'),
                             'TotalTrasladosImpuestoIVA8': Decimal('1231.22')},
                 'Version': '2.0'},
 ...
 'Receptor': {'DomicilioFiscalReceptor': '59820',
              ...
              'Rfc': 'KIJ0906199R1',
              'UsoCFDI': 'CP01'},
 'Sello': '',
 'Serie': 'A',
 'SubTotal': Decimal('0'),
 'TipoCambio': None,
 'TipoDeComprobante': 'P',
