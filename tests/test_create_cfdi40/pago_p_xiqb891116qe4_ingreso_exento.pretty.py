{'Addenda': None,
 ...
 'Complemento': {'Pago': [{'DoctoRelacionado': [{'EquivalenciaDR': 1,
                                                 ...
                                                 'ImpuestosDR': {'RetencionesDR': [{'BaseDR': Decimal('3605.69'),
                                                                                    'ImporteDR': Decimal('360.57'),
                                                                                    'ImpuestoDR': Code('001', 'ISR'),
                                                                                    'TasaOCuotaDR': Decimal('0.100000'),
                                                                                    'TipoFactorDR': Code('Tasa', None)}],
                                                                 'TrasladosDR': [{'BaseDR': Decimal('3605.69'),
                                                                                  'ImporteDR': None,
                           ...
                           'FormaDePagoP': '03',
                           'ImpuestosP': {'RetencionesP': [{'ImporteP': Decimal('360.57'),
                                                            'ImpuestoP': Code('001', 'ISR')}],
                                          'TrasladosP': [{'BaseP': Decimal('3605.69'),
                                                          'ImporteP': None,
                 ...
                 'Totales': {'MontoTotalPagos': Decimal('3245.12'),
                             'TotalRetencionesISR': Decimal('360.57'),
                             'TotalTrasladosBaseIVAExento': Decimal('3605.69')},
                 'Version': '2.0'},
 ...
 'Receptor': {'DomicilioFiscalReceptor': '59820',
              ...
              'Rfc': 'KIJ0906199R1',
              'UsoCFDI': 'CP01'},
 'Sello': '',
 'Serie': 'A',
 'SubTotal': Decimal('0'),
 'TipoCambio': None,
 'TipoDeComprobante': 'P',
