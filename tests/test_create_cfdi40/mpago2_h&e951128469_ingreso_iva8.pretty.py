{'Addenda': None,
 ...
 'Complemento': {'Pago': [{'DoctoRelacionado': [{'EquivalenciaDR': 1,
                                                 ...
                                                 'ImpPagado': Decimal('16621.52'),
                                                 'ImpSaldoAnt': Decimal('16621.52'),
                                                 'ImpSaldoInsoluto': Decimal('0.00'),
                                                 'ImpuestosDR': {'TrasladosDR': [{'BaseDR': Decimal('15390.30'),
                                                                                  'ImporteDR': Decimal('1231.22'),
                                                                                  'ImpuestoDR': Code('002', 'IVA'),
                                                                                  'TasaOCuotaDR': Decimal('0.080000'),
                           ...
                           'ImpuestosP': {'TrasladosP': [{'BaseP': Decimal('30780.60'),
                                                          'ImporteP': Decimal('2462.44'),
                                                          'ImpuestoP': Code('002', 'IVA'),
                                                          'TasaOCuotaP': Decimal('0.080000'),
                                                          'TipoFactorP': Code('Tasa', None)}]},
                           'MonedaP': Code('MXN', 'Peso Mexicano'),
                           'Monto': Decimal('33243.04'),
                           'TipoCambioP': 1}],
                 'Totales': {'MontoTotalPagos': Decimal('33243.04'),
                             'TotalTrasladosBaseIVA8': Decimal('30780.60'),
                             'TotalTrasladosImpuestoIVA8': Decimal('2462.44')},
                 'Version': '2.0'},
 ...
 'Receptor': {'DomicilioFiscalReceptor': '59820',
              ...
              'Rfc': 'KIJ0906199R1',
              'UsoCFDI': 'CP01'},
 'Sello': '',
 'Serie': 'A',
 'SubTotal': Decimal('0'),
 'TipoCambio': None,
 'TipoDeComprobante': 'P',
