{'Addenda': None,
 ...
 'Complemento': {'Pago': [{'DoctoRelacionado': [{'EquivalenciaDR': 1,
                                                 ...
                                                 'ImpuestosDR': {'TrasladosDR': [{'BaseDR': Decimal('3004.74'),
                                                                                  'ImporteDR': Decimal('240.38'),
                           ...
                           'FormaDePagoP': '03',
                           'ImpuestosP': {'TrasladosP': [{'BaseP': Decimal('3004.74'),
                                                          'ImporteP': Decimal('240.38'),
                 ...
                 'Totales': {'MontoTotalPagos': Decimal('3245.12'),
                             'TotalTrasladosBaseIVA8': Decimal('3004.74'),
                             'TotalTrasladosImpuestoIVA8': Decimal('240.38')},
                 'Version': '2.0'},
 ...
 'Receptor': {'DomicilioFiscalReceptor': '59820',
              ...
              'Rfc': 'KIJ0906199R1',
              'UsoCFDI': 'CP01'},
 'Sello': '',
 'Serie': 'A',
 'SubTotal': Decimal('0'),
 'TipoCambio': None,
 'TipoDeComprobante': 'P',
