{'Certificado': '',
 'CfdiRetenRelacionados': {'TipoRelacion': Code('09', 'Factura generada por pagos diferidos'),
                           'UUID': '13fec5b0-843d-4d49-b30a-af93adcbee02'},
 'Complemento': {'Arrendamientoenfideicomiso': {'DeduccCorresp': Decimal('0.00'),
                                                'DescrMontOtrosConceptDistr': 'NO '
                                                                              'HAY',
                                                'MontOtrosConceptDistr': Decimal('0.00'),
                                                'MontResFiscDistFibras': Decimal('0.00'),
                                                'MontTotRet': Decimal('0.00'),
                 ...
                 'Dividendos': {'DividOUtil': {'CveTipDivOUtil': Code('01', 'Proviene de CUFIN'),
                                               'MontDivAcumExt': Decimal('10.1'),
                                               'MontDivAcumNal': Decimal('10.1'),
                                               'MontISRAcredNal': Decimal('0.1'),
                                               'MontISRAcredRetExtranjero': Decimal('0.00'),
                                               'MontISRAcredRetMexico': Decimal('0.00'),
                                               'MontRetExtDivExt': Decimal('0.00'),
                                               'TipoSocDistrDiv': 'Sociedad '
                                                                  'Nacional'},
                                'Remanente': {'ProporcionRem': Decimal('10.0')},
                                'Version': '1.0'},
                 ...
                 'Intereseshipotecarios': {'CreditoDeInstFinanc': 'NO',
                                           'MontTotIntNominalesDev': Decimal('0.00'),
                                           'MontTotIntNominalesDevYPag': Decimal('0.00'),
                                           'MontTotIntRealPagDeduc': Decimal('0.00'),
                                           'NumContrato': '10000000000',
                                           'PropDeducDelCredit': Decimal('0.00'),
                 ...
                 'Planesderetiro': {'AportacionesODepositos': [{'MontAportODep': Decimal('1000000.00'),
                                    ...
                                    'MontTotAportAnioInmAnterior': Decimal('0.00'),
                 ...
                 'SectorFinanciero': {'DescripFideicom': 'DEScRIPCION DEL '
                                                         'FIDEICOM',
                                      'IdFideicom': '191216',
                                      'NomFideicom': 'NOMBRE DEL FIDEICOM',
                                      'Version': '1.0'},
 ...
 'Receptor': {'Nacional': {'CurpR': 'XAXX010101HNTXXX00',
                           'DomicilioFiscalR': '99999',
                           'NomDenRazSocR': 'PERSONA FISICA NACIONAL DE PRUEBA',
                           'RfcR': 'XAXX010101000'},
              'NacionalidadR': 'Nacional'},
 'Sello': '',
 'Totales': {'ISRCorrespondiente': Decimal('11.2'),
             'ImpRetenidos': [{'BaseRet': Decimal('8.0'),
                               'ImpuestoRet': Code('001', 'ISR'),
                               'MontoRet': Decimal('1.00'),
                               'TipoPagoRet': Code('02', 'Pago definitivo IEPS')},
                              {'BaseRet': Decimal('16.0'),
                               'ImpuestoRet': Code('002', 'IVA'),
                               'MontoRet': Decimal('1.00'),
                               'TipoPagoRet': Code('03', 'Pago definitivo ISR')},
                              {'BaseRet': Decimal('16.0'),
                               'ImpuestoRet': Code('003', 'IEPS'),
                               'MontoRet': Decimal('1.00'),
                               'TipoPagoRet': Code('04', 'Pago provisional ISR')}],
             'MontoTotExent': Decimal('1.00'),
             'MontoTotGrav': Decimal('1.00'),
             'MontoTotOperacion': Decimal('1.00'),
             'MontoTotRet': Decimal('1.00'),
             'UtilidadBimestral': Decimal('12')},
 'Version': '2.0'}