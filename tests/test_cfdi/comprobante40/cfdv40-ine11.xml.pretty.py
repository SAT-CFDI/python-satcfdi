{'Certificado': '',
 ...
 'Complemento': {'INE': {'Entidad': [{'Ambito': Code('Federal', None),
                                      'ClaveEntidad': Code('ZAC', ['MEX', 'Zacatecas']),
                                      'Contabilidad': [123456]}],
                         'IdContabilidad': 123456,
                         'TipoComite': Code('Directivo Estatal', None),
                         'TipoProceso': Code('Campaña', None),
                         'Version': '1.1'}},
