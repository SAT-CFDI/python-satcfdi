{'Certificado': '',
 ...
 'Complemento': {'Donatarias': {'FechaAutorizacion': datetime.date(1973, 4, 4),
                                'Leyenda': 'Este comprobante ampara un '
                                           'donativo, el cual será destinado '
                                           'por la donataria a los fines '
                                           'propios de su objeto social. En el '
                                           'caso de que los bienes donados '
                                           'hayan sido deducidos previamente '
                                           'para los efectos del impuesto '
                                           'sobre la renta, este donativo no '
                                           'es deducible. La reproducción no '
                                           'autorizada de este comprobante '
                                           'constituye un delito en los '
                                           'términos de las disposiciones '
                                           'fiscales.',
                                'NoAutorizacion': '123456ABC',
                                'Version': '1.1'}},
