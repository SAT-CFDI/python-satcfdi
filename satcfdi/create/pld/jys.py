...
class DatosBienLiquidacionType(XElement):
    def __init__(
            self,
...
class LiquidacionEspecieType(XElement):
    def __init__(
            self,
            valor_bien: str,
            moneda: str,
...
class LiquidacionNumerarioType(XElement):
    def __init__(
            self,
            fecha_pago: date,
...
class DatosSucursalOperadorType(XElement):
    def __init__(
            self,
            nombre_operador: str,
            codigo_postal: str,
...
class DatosSucursalPropiaType(XElement):
    def __init__(
            self,
            codigo_postal: str,
    ): 
...
class TipoSucursalType(XElement):
    def __init__(
            self,
