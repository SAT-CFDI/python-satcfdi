"""oba http://www.uif.shcp.gob.mx/recepcion/oba"""
...
class DatosObjetoType(ScalarMap):
    """
...
class DatosOperacionType(ScalarMap):
    ...
    def __init__(
            ...
            codigo_postal: str,
            tipo_operacion: str,
            datos_objeto: DatosObjetoType | dict | Sequence[DatosObjetoType | dict],
...
class Archivo(ArchivoType, XElement):
    tag = '{http://www.uif.shcp.gob.mx/recepcion/oba}archivo'
