...
class RemolqueCCP(ScalarMap):
    ...
    :param placa_ccp: Atributo requerido para registrar los caracteres alfanuméricos, sin guiones ni espacios de la placa vehicular del autotransporte registrado en el CFDI con complemento Carta Porte, únicamente aplica para traslado mediante ferri.
    """
...
class TransporteMaritimo(ScalarMap):
    ...
    :param remolques_ccp: Nodo condicional para registrar los datos del(los) remolque(s) o semirremolque(s) que se adaptan al autotransporte que realizó el traslado de los bienes y/o mercancías registrado en el CFDI con complemento Carta Porte de autotransporte, únicamente aplica para traslado mediante ferri.
    """
    ...
    def __init__(
            ...
            contenedor: Contenedor | dict | Sequence[Contenedor | dict] = None,
            remolques_ccp: RemolqueCCP | dict | Sequence[RemolqueCCP | dict] = None,
    ): 
        super().__init__({
...
class Mercancia(ScalarMap):
    ...
    :param folio_impo_vucem: Atributo condicional para registrar el número de folio de importación VUCEM para la identificación del documento, para el traslado de medicamentos, precursores o químicos de uso dual, sustancias tóxicas, plaguicidas o fertizantes.
