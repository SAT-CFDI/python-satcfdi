...
class FiguraTransporte(XElement):
    """
    http://www.sat.gob.mx/CartaPorte
...
class AutotransporteFederal(XElement):
    """
    http://www.sat.gob.mx/CartaPorte
